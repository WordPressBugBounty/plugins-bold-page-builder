...
class bt_bb_tabs extends BT_BB_Element {
	...
	function map_shortcode() {
		...
		bt_bb_map( $this->shortcode, array( 'name' => esc_html__( 'Tabs', 'bold-page-builder' ), 'description' => esc_html__( 'Tabs container', 'bold-page-builder' ), 'container' => 'vertical', 'toggle' => true, 'accept' => array( 'bt_bb_tab_item' => true ), 'icon' => $this->prefix_backend . 'icon' . '_' . $this->shortcode,
			'params' => array(
