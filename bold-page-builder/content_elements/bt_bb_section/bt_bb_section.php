...
class bt_bb_section extends BT_BB_Element {
		...
		if ( $background_image != ''){
			...
			if ( $background_image_url != '' ) {
				if ( $lazy_load == 'yes' ) {
					...
					$background_image_data_attr .= ' data-background_image_src="' . esc_url( $background_image_url ) . '"';
	...
	function map_shortcode() {
		...
		bt_bb_map( $this->shortcode, array( 'name' => esc_html__( 'Section', 'bold-page-builder' ), 'description' => esc_html__( 'Basic root element', 'bold-page-builder' ), 'root' => true, 'container' => 'vertical', 'accept' => array( 'bt_bb_row' => true ), 'toggle' => true, 'auto_add' => 'bt_bb_row', 'show_settings_on_create' => false,
			'params' => array( 
				array( 'param_name' => 'layout', 'type' => 'dropdown', 'default' => 'boxed_1200', 'heading' => esc_html__( 'Layout', 'bold-page-builder' ), 'group' => esc_html__( 'General', 'bold-page-builder' ), 'weight' => 0, 'preview' => true,
					'value' => array(
						esc_html__( 'Boxed (800px)', 'bold-page-builder' ) => 'boxed_800',
						esc_html__( 'Boxed (900px)', 'bold-page-builder' ) => 'boxed_900',
						esc_html__( 'Boxed (1000px)', 'bold-page-builder' ) => 'boxed_1000',
						esc_html__( 'Boxed (1100px)', 'bold-page-builder' ) => 'boxed_1100',
						...
						esc_html__( 'Boxed (1700px)', 'bold-page-builder' ) => 'boxed_1700',
						esc_html__( 'Boxed (1800px)', 'bold-page-builder' ) => 'boxed_1800',
						esc_html__( 'Wide', 'bold-page-builder' ) => 'wide'
					)
				),
				...
				array( 'param_name' => 'full_screen', 'type' => 'dropdown', 'heading' => esc_html__( 'Full screen', 'bold-page-builder' ), 
					'value' => array(
						esc_html__( 'No', 'bold-page-builder' )  => '',
						esc_html__( 'Yes', 'bold-page-builder' ) => 'yes'
					)
				),
				array( 'param_name' => 'vertical_align', 'type' => 'dropdown', 'heading' => esc_html__( 'Vertical align (for fullscreen section)', 'bold-page-builder' ), 'preview' => true,
					'value' => array(
				...
				array( 'param_name' => 'background_color', 'type' => 'colorpicker', 'heading' => esc_html__( 'Background color', 'bold-page-builder' ), 'group' => esc_html__( 'Design', 'bold-page-builder' ), 'preview' => true ),
				...
				array( 'param_name' => 'lazy_load', 'type' => 'dropdown', 'default' => 'yes', 'heading' => esc_html__( 'Lazy load background image', 'bold-page-builder' ),
					'value' => array(
						esc_html__( 'No', 'bold-page-builder' )  => 'no',
						esc_html__( 'Yes', 'bold-page-builder' ) => 'yes'
					)
				),
				array( 'param_name' => 'background_overlay', 'type' => 'dropdown', 'heading' => esc_html__( 'Background overlay', 'bold-page-builder' ), 'group' => esc_html__( 'Design', 'bold-page-builder' ), 
					'value' => array(
						esc_html__( 'No overlay', 'bold-page-builder' )     => '',
						esc_html__( 'Light stripes', 'bold-page-builder' )  => 'light_stripes',
						esc_html__( 'Dark stripes', 'bold-page-builder' )   => 'dark_stripes',
						esc_html__( 'Light solid', 'bold-page-builder' )    => 'light_solid',
						esc_html__( 'Dark solid', 'bold-page-builder' )     => 'dark_solid',
						esc_html__( 'Light gradient', 'bold-page-builder' ) => 'light_gradient',
						esc_html__( 'Dark gradient', 'bold-page-builder' )  => 'dark_gradient'
					)
				),
				array( 'param_name' => 'parallax', 'type' => 'textfield', 'heading' => esc_html__( 'Parallax', 'bold-page-builder' ), 'placeholder' => esc_html__( 'E.g. 0.7, 2 = fixed', 'bold-page-builder' ), 'group' => esc_html__( 'Design', 'bold-page-builder' ) ),
				array( 'param_name' => 'parallax_offset', 'type' => 'textfield', 'heading' => esc_html__( 'Parallax offset in px', 'bold-page-builder' ), 'placeholder' => esc_html__( 'E.g. -100', 'bold-page-builder' ), 'group' => esc_html__( 'Design', 'bold-page-builder' ) ),
				array( 'param_name' => 'parallax_zoom_start', 'type' => 'textfield', 'heading' => esc_html__( 'Background parallax zoom start', 'bold-page-builder' ), 'placeholder' => esc_html__( 'E.g. 1', 'bold-page-builder' ), 'group' => esc_html__( 'Design', 'bold-page-builder' ) ),
				array( 'param_name' => 'parallax_zoom_end', 'type' => 'textfield', 'heading' => esc_html__( 'Background parallax zoom end', 'bold-page-builder' ), 'placeholder' => esc_html__( 'E.g. 2', 'bold-page-builder' ), 'group' => esc_html__( 'Design', 'bold-page-builder' ) ),
				array( 'param_name' => 'parallax_blur_start', 'type' => 'textfield', 'heading' => esc_html__( 'Background parallax blur start', 'bold-page-builder' ), 'placeholder' => esc_html__( 'E.g. 0', 'bold-page-builder' ), 'group' => esc_html__( 'Design', 'bold-page-builder' ) ),
				array( 'param_name' => 'parallax_blur_end', 'type' => 'textfield', 'heading' => esc_html__( 'Background parallax blur end', 'bold-page-builder' ), 'placeholder' => esc_html__( 'E.g. 10', 'bold-page-builder' ), 'group' => esc_html__( 'Design', 'bold-page-builder' ) ),
				array( 'param_name' => 'parallax_opacity_start', 'type' => 'textfield', 'heading' => esc_html__( 'Background parallax opacity start', 'bold-page-builder' ), 'placeholder' => esc_html__( 'E.g. 1', 'bold-page-builder' ), 'group' => esc_html__( 'Design', 'bold-page-builder' ) ),
				array( 'param_name' => 'parallax_opacity_end', 'type' => 'textfield', 'heading' => esc_html__( 'Background parallax opacity end', 'bold-page-builder' ), 'placeholder' => esc_html__( 'E.g. 0', 'bold-page-builder' ), 'group' => esc_html__( 'Design', 'bold-page-builder' ) ),
				array( 'param_name' => 'top_section_coverage_image', 'type' => 'attach_image',  'preview' => true, 'heading' => esc_html__( 'Top coverage image', 'bold-page-builder' ), 'group' => esc_html__( 'Design', 'bold-page-builder' ) ),
				array( 'param_name' => 'bottom_section_coverage_image', 'type' => 'attach_image',  'preview' => true, 'heading' => esc_html__( 'Bottom coverage image', 'bold-page-builder' ), 'group' => esc_html__( 'Design', 'bold-page-builder' ) ),
				
				array( 'param_name' => 'background_video_yt', 'type' => 'textfield', 'heading' => esc_html__( 'YouTube background video', 'bold-page-builder' ), 'placeholder' => esc_html__( 'Enter video URL', 'bold-page-builder' ), 'group' => esc_html__( 'Video', 'bold-page-builder' ) ),
				array( 'param_name' => 'yt_video_settings', 'type' => 'textfield', 'heading' => esc_html__( 'YouTube video settings', 'bold-page-builder' ), 'placeholder' => esc_html__( 'E.g. startAt:20, mute:true, stopMovieOnBlur:false', 'bold-page-builder' ), 'group' => esc_html__( 'Video', 'bold-page-builder' ) ),
				array( 'param_name' => 'background_video_mp4', 'type' => 'textfield', 'heading' => esc_html__( 'MP4 background video', 'bold-page-builder' ), 'placeholder' => esc_html__( 'Enter video URL'
					, 'bold-page-builder' ), 'group' => esc_html__( 'Video', 'bold-page-builder' ) ),
				array( 'param_name' => 'background_video_ogg', 'type' => 'textfield', 'heading' => esc_html__( 'OGG background video', 'bold-page-builder' ), 'placeholder' => esc_html__( 'Enter video URL', 'bold-page-builder' ), 'group' => esc_html__( 'Video', 'bold-page-builder' ) ),
				array( 'param_name' => 'background_video_webm', 'type' => 'textfield', 'heading' => esc_html__( 'WEBM background video', 'bold-page-builder' ), 'placeholder' => esc_html__( 'Enter video URL', 'bold-page-builder' ), 'group' => esc_html__( 'Video', 'bold-page-builder' ) ),
				array( 'param_name' => 'show_video_on_mobile',  'type' => 'checkbox', 'value' => array( esc_html__( 'Yes', 'bold-page-builder' ) => 'yes' ), 'default' => '', 'heading' => esc_html__( 'Show video on mobile devices', 'bold-page-builder' ), 'group' => esc_html__( 'Video', 'bold-page-builder' ) )
			)
		) );		
