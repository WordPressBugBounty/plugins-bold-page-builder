...
class bt_bb_content_slider extends BT_BB_Element {
	...
	function map_shortcode() {
		bt_bb_map( $this->shortcode, array( 'name' => esc_html__( 'Slider', 'bold-page-builder' ), 'description' => esc_html__( 'Slider with custom content', 'bold-page-builder' ), 'container' => 'vertical', 'accept' => array( 'bt_bb_content_slider_item' => true ), 'toggle' => true, 'icon' => $this->prefix_backend . 'icon' . '_' . $this->shortcode,
			'params' => array(
				array( 'param_name' => 'height', 'type' => 'dropdown', 'preview' => true, 'heading' => esc_html__( 'Size', 'bold-page-builder' ),
					'value' => array(
				...
				array( 'param_name' => 'animation', 'preview' => true, 'default' => 'slide', 'type' => 'dropdown', 'heading' => esc_html__( 'Animation', 'bold-page-builder' ), 'description' => esc_html__( 'If fade is selected, number of slides to show will be 1', 'bold-page-builder' ),
					'value' => array(
						esc_html__( 'Default (slide)', 'bold-page-builder' ) => 'slide',
						esc_html__( 'Fade', 'bold-page-builder' ) 			=> 'fade'
					)
				),
				array( 'param_name' => 'direction', 'preview' => true, 'default' => 'default', 'type' => 'dropdown', 'heading' => esc_html__( 'Direction', 'bold-page-builder' ), 'description' => esc_html__( 'Default option follows Wordpress language settings.', 'bold-page-builder' ),
					'value' => array(
						esc_html__( 'Default (switch rtl / ltr)', 'bold-page-builder' ) 	=> 'default',
						esc_html__( 'Left to right', 'bold-page-builder' ) 				=> 'ltr',
						esc_html__( 'Right to left', 'bold-page-builder' ) 				=> 'rtl'
					)
				),
				...
				array( 'param_name' => 'slides_to_show', 'type' => 'dropdown', 'preview' => true, 'heading' => esc_html__( 'Number of slides to show', 'bold-page-builder' ), 'description' => esc_html__( 'If fade animation is selected, number will be 1 anyway', 'bold-page-builder' ), 'responsive_override' => true,
					'value' => array(
				...
				array( 'param_name' => 'arrows_size', 'type' => 'dropdown', 'preview' => true, 'default' => 'normal', 'heading' => esc_html__( 'Navigation arrows size', 'bold-page-builder' ), 'group' => esc_html__( 'Navigation', 'bold-page-builder' ),
					'value' => array(
						esc_html__( 'No arrows', 'bold-page-builder' ) 		=> 'no_arrows',
						esc_html__( 'Small', 'bold-page-builder' ) 			=> 'small',
						esc_html__( 'Normal', 'bold-page-builder' ) 			=> 'normal',
						esc_html__( 'Large', 'bold-page-builder' ) 			=> 'large'
					)
				),
				array( 'param_name' => 'show_dots', 'type' => 'dropdown', 'heading' => esc_html__( 'Dots navigation', 'bold-page-builder' ), 'group' => esc_html__( 'Navigation', 'bold-page-builder' ),
					'value' => array(
